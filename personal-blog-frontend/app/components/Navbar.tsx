...
const Navbar = () => {
  ...
  return (
    <nav>
      <div className="bg-neutral-900 flex flex-wrap justify-between px-2 py-1.5 rounded-xl">
        <img
        ...
        <div className="flex items-center gap-2">
          <div className="flex">
            <div className="hidden gap-5 flex-wrap items-center  md:flex">
              <NavLink
                to="/home"
          ...
          <button className="hover:cursor-pointer p-2 border-1 border-neutral-700 rounded-xl bg-transparent">
            <img src={iconSun} alt="" className="" />
          </button>
        </div>
      </div>

      {isMobile && (
        <div className="bg-neutral-800 rounded-xl p-2 flex flex-col mt-2 [&>*]:not-last:pb-1   [&>*]:not-last:border-b-1 [&>*]:not-last:border-b-violet-500 ">
          <NavLink
            to="/home"
            className={({ isActive }) => (isActive ? "bg-blue-500" : "")}
          >
